...
Route::middleware([CheckIsLogged::class, CheckIsAdmin::class])->group(function () {
    ...
    Route::get('/admin/delete-user/{id}',   [MainController::class, 'adminDeleteUser'])->name('admin_delete_user');
    Route::get('/admin/restore-user/{id}',  [MainController::class, 'adminRestoreUser'])->name('admin_restore_user');
    Route::get('/admin/delete-media/{id}',  [MainController::class, 'adminDeleteMedia'])->name('admin_delete_media');
    Route::get('/admin/restore-media/{id}', [MainController::class, 'adminRestoreMedia'])->name('admin_restore_media');
});